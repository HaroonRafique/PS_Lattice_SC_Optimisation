<h1> LHC PROTON -  flat top  optics</h1>

<h2>Twiss functions</h2>
The Twiss functions of this configuration are shown in the interactive plot below. You can zoom in or hover over any curve to obtain more information about the function's value at a specific element. The full TFS table is available [here](ps_ft_lhc.tfs){target=_blank} and the plot in PDF format [here](ps_ft_lhc.pdf){target=_blank}. 

<object width="100%" height="520" data="ps_ft_lhc.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/lhc_proton/2_flat_top/MADX_example_ps_ft_lhc.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_ft_lhc.madx)"
        /**********************************************************************************
        *
...
??? "MAD-X strength file - [direct download](ps_ft_lhc.str)"
        /*******************************************************************************
        **                        SBEND K1 and multipoles in MUs                      **
        *******************************************************************************/
        ! 
        ! step 1): use the integrated normalized multipoles from the magnetic model at 5386 A. 
        ! The field obtained in simulations doesn't match the measured one, but using the normalized harmonics should be close enough.
        ! step 2): match the measured non-linear chromaticity: sextupole components in the SBENDs (PFW-like) and octupole components with the multipoles
        ...
        /********  from the magnetic model at 5386 A *********/

        mpk2               =     -0.026860752039551218 ;
        mpk2_j             =     -0.022490759823338775 ;
