...
??? "MAD-X example script - [direct download](ps_pro_bare_machine.madx)"
        ...
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,normal,no=4, file = './ps_pro_bare_machine.tfs';
        ptc_end;

        WRITE, TABLE=NONLIN, FILE="nonlin.dat";

        value, table(nonlin,value,7);
        value, table(nonlin,value,7)*beam->beta;
        value, table(nonlin,value,7)*beam->beta*beam->beta;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true,;
        ptc_twiss,closed_orbit,icase=56,no=4,slice_magnets=true, file = './ps_pro_bare_machine_interpolated.tfs';
        ptc_end;

        /******************************************************************
         *                Non-linear chromaticity matching
         *
         *      Values based on non-linear chromaticity measurement at  
         *                flat bottom recorded on 09.04.2018
         ******************************************************************/
        ...
        Assign, echo="./ps_pro_bare_machine_matching.dat";
        value, K1_F, K1_D;
        value, MPK2, MPK2_J;
        value, MPK3_F, MPK3_D;
...
??? "MAD-X strength file - [direct download](ps_pro_bare_machine.str)"
        /*******************************************************************************
