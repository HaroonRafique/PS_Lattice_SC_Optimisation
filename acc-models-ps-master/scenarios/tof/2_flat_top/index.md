<h1> TOF -  flat top  optics</h1>

<h2>Twiss functions</h2>
The Twiss functions of this configuration are shown in the interactive plot below. You can zoom in or hover over any curve to obtain more information about the function's value at a specific element. The full TFS table is available [here](ps_ft_tof.tfs){target=_blank} and the plot in PDF format [here](ps_ft_tof.pdf){target=_blank}. 

<object width="100%" height="520" data="ps_ft_tof.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/tof/2_flat_top/MADX_example_ps_ft_tof.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_ft_tof.madx)"
        /**********************************************************************************
        *
        ...
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_ft_tof.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true,;
        ptc_twiss,closed_orbit,icase=56,no=4,slice_magnets=true, file = './ps_ft_tof_interpolated.tfs';
        ptc_end;
        ...
        Assign, echo="./ps_ft_tof_matching.dat";
        value, K1_F, K1_D;
        value, K2_F, K2_D;
        value, MPK2, MPK2_J;
        value, MPK3_F, MPK3_D;
...
??? "MAD-X strength file - [direct download](ps_ft_tof.str)"
        /*******************************************************************************
