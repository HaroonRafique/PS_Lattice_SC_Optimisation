<h1> TOF -  extraction optics</h1>

<h2>Twiss functions</h2>
The Twiss functions of this configuration are shown in the interactive plot below. You can zoom in or hover over any curve to obtain more information about the function's value at a specific element. The full TFS table is available [here](ps_ext_tof.tfs){target=_blank} and the plot in PDF format [here](ps_ext_tof.pdf){target=_blank}. 

<object width="100%" height="680" data="ps_ext_tof.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/tof/3_extraction/MADX_example_ps_ext_tof.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_ext_tof.madx)"
        /**********************************************************************************
        *
        ...
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_ext_tof.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true,;
        ptc_twiss,closed_orbit,icase=56,no=4,slice_magnets=true, file = './ps_ext_tof_interpolated.tfs';
        ptc_end;

??? "MAD-X strength file - [direct download](ps_ext_tof.str)"
        /*******************************************************************************
        **                        SBEND K1 and multipoles in MUs                      **
        *******************************************************************************/
        ! 
        ! step 1): use same values as for the bare machine at p = 2.14 GeV/c. 
        ! TODO: Update using simulation results from the magnetic model at 3891 A.
        ...
        **********************************/
        ...
        mpk2               =           -0.01858 ;
        mpk2_j             =           0.039347 ;
        mpk3_f             =     0.007859325227 ;
        mpk3_d             =      0.04459584784 ;

        /*******************************************************************************
        **                        Extraction elements                                 **
        *******************************************************************************/

        KQKE16 = 1360 * (1470.E-6/0.20) / BRHO;
