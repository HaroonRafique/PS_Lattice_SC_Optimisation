...
<object width="1100" height="500" data="ps_pr_sftpro_2.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/sftpro/5_phase_rotation/MADX_example_ps_pr_sftpro.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_pr_sftpro.madx)"
        /**********************************************************************************
        *
        ...
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_pr_sftpro.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,slice_magnets=true,no=4, file = './ps_pr_sftpro_interpolated.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_pr_sftpro_islands.tfs', x = 0.024, px = 0.0025;
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,slice_magnets=true,no=4, file = './ps_pr_sftpro_islands_interpolated.tfs', x = 0.024, px = 0.0025;
        ptc_end;


??? "MAD-X strength file - [direct download](ps_pr_sftpro.str)"
        /*******************************************************************************
        ...
        *******************************************************************************/
        ...
        kf                 =    0.0007650385622922311 ;
        kd                 =   -0.0004231357375287169 ;
