<h1> SFTPRO -  horizontal splitting  optics</h1>

<h2>Twiss functions</h2>
The Twiss functions of this configuration are shown in the interactive plot below. You can zoom in or hover over any curve to obtain more information about the function's value at a specific element. The full TFS table is available [here](ps_hs_sftpro.tfs){target=_blank} and the plot in PDF format [here](ps_hs_sftpro.pdf){target=_blank}. 

<object width="100%" height="720" data="ps_hs_sftpro.html"></object> 



<h2>Horizontal phase space during the splitting</h2>
...
<object width="1100" height="500" data="ps_hs_sftpro_2.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/sftpro/4_horizontal_splitting/MADX_example_ps_hs_sftpro.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_hs_sftpro.madx)"
        /**********************************************************************************
        *
        * MAD-X input script for the MTE splitting configuration at 800 ms cycle time
        * on the SFTPRO cycle.
        * 14/08/2019 - Alexander Huschauer
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_hs_sftpro.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,slice_magnets=true,no=4, file = './ps_hs_sftpro_interpolated.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_hs_sftpro_islands.tfs', x = 0.032;
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true;
        ptc_twiss,closed_orbit,icase=56,slice_magnets=true,no=4, file = './ps_hs_sftpro_islands_interpolated.tfs', x = 0.032;
        ptc_end;

??? "MAD-X strength file - [direct download](ps_hs_sftpro.str)"
        /*******************************************************************************
        ...
        *******************************************************************************/
        ...
        kf                 =    0.0003230585988342585 ;
        kd                 =   -0.00017900076340444273 ;

        /*******************************************************************************
        **                         Settings of MTE elements                           **
        *******************************************************************************/
