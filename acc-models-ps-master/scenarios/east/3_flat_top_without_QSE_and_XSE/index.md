<h1> EAST -  flat top without QSE and XSE  optics</h1>

<h2>Twiss functions</h2>
The Twiss functions of this configuration are shown in the interactive plot below. You can zoom in or hover over any curve to obtain more information about the function's value at a specific element. The full TFS table is available [here](ps_ft_east.tfs){target=_blank} and the plot in PDF format [here](ps_ft_east.pdf){target=_blank}. 

<object width="100%" height="520" data="ps_ft_east.html"></object> 



<h2>Example scripts</h2>

You can directly open a MAD-X example for this configuration in [SWAN](https://cern.ch/swanserver/cgi-bin/go?projurl=https://gitlab.cern.ch/acc-models/acc-models-ps/raw/master/scenarios/east/3_flat_top_without_QSE_and_XSE/MADX_example_ps_ft_east.ipynb){target=_blank} or download the necessary files below.

??? "MAD-X example script - [direct download](ps_ft_east.madx)"
        /**********************************************************************************
        *
        ...
        ************************************************************************************/
        ...
        ptc_twiss,closed_orbit,icase=56,no=4, file = './ps_ft_east.tfs';
        ptc_end;
        ...
        ptc_create_universe;
        ptc_create_layout, model=2, method=6, nst=5, exact=true,;
        ptc_twiss,closed_orbit,icase=56,no=4,slice_magnets=true, file = './ps_ft_east_interpolated.tfs';
        ptc_end;
        ...
        Assign, echo="./ps_ft_east_tune_matching.dat";
        value, k1_f, k1_d;
        ...
        Assign, echo="./ps_ft_east_chroma_matching.dat";
        value, k2_f, k2_d;
        Assign, echo=terminal;
        ...
        Assign, echo="./ps_ft_east_q2p_matching.dat";
        value, MPK3_F, MPK3_D;
        Assign, echo=terminal;
...
??? "MAD-X strength file - [direct download](ps_ft_east.str)"
        /*******************************************************************************
