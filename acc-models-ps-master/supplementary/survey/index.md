<h1> PS survey file </h1>

On this page the MAD-X input scripts for the PS survey and the survey file can be found. 
Furthermore, the following interactive plot shows the coordinates of the individual elements and the survey output file is available [here](ps_survey.tfs){target=_blank}.

Disclaimer: The initial survey coordinates still need to be verified!

<object width="50%" height="520px" data="ps_survey.html"></object> 
<p style="text-align: center;"><b>Figure 1:</b> Result of the MAD-X survey for the PS. The shaded areas indicate the different sectors and the lightest color corresponds to the first sector.</p>

??? "MAD-X example script for PS survey - [direct download](ps_survey.madx)"
        /**********************************************************************************
        *
        * MAD-X input script to create a SURVEY file.
        * 27/08/2019 - Alexander Huschauer
        ************************************************************************************/
        ...
        survey, file = 'ps_survey.tfs', x0 = -2045.1130, y0 = 2433.6599, z0 = 2008.5893, theta0 = -2.68536;
